...
- LLM 자체 지식 우선 (즉석 합성)
- 부족하면 심부름꾼에게 1회 fetch 위임 (예: "Solidity 감사 안티패턴 5개 찾아줘")
- agency-agents 같은 외부 자원이 있으면 참고 (부록 참조)
...
| 도메인 깊이 | 목표 줄 수 |
|-----------|----------|
| 일반적 (개발자, 리서처, 작성자) | 100~120줄 |
| 전문 (Solidity 감사, 임베디드, GIS, 회계감사) | 130~150줄 |
| 단순 보조 (자료 정리, 포맷팅) | 80~100줄 |
